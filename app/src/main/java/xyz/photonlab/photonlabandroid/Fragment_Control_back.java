...
public class Fragment_Control_back extends Fragment implements dialog_colorpicker.colorPick_Listener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((dialog_colorpicker) newFragment).setListener(Fragment_Control_back.this);
